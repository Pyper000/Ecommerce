...
_EXTRA_SPECS: list[tuple] = [
    ...
    # ---- 旅行装备补充：更细的材质、价格、收纳与出行场景 ----
    ("P1061", "PackCloud 旅行洗漱包 悬挂款", "PackCloud", "旅行装备", "CN",
     "悬挂洗漱包 分层收纳 防水内衬 便携 适合酒店 出差 旅行整理",
     ["CN", "US", "SG"], [("S1", "雾蓝", 89.0, "CNY", 120)], [("收纳", "多分层悬挂式")]),
    ("P1062", "AirNest 记忆棉护颈枕 Pro", "AirNest", "旅行装备", "CN",
     "记忆棉 护颈枕 可压缩 U型 长途飞行 轻便 不压肩",
     ["CN", "US", "EU"], [("S1", "深灰", 119.0, "CNY", 90)], [("支撑", "慢回弹记忆棉")]),
    ("P1063", "FieldBento 户外折叠餐盒", "FieldBento", "旅行装备", "CN",
     "折叠餐盒 食品级硅胶 轻便 可微波 分隔 露营 便携",
     ["CN", "US", "JP"], [("S1", "卡其", 69.0, "CNY", 140)], [("材质", "食品级硅胶")]),
    ...
    # ---- 家居生活补充：更像“买回家就能用”的生活小物 ----
    ("P1064", "SoftGlow 床头小夜灯", "SoftGlow", "家居生活", "CN",
     "床头灯 暖光 触控调光 充电 适合卧室 读书 睡前氛围",
     ["CN", "US", "EU"], [("S1", "奶油白", 99.0, "CNY", 100)], [("光源", "三档暖光")]),
    ("P1065", "FreshStack 冰箱收纳盒 4件套", "FreshStack", "家居生活", "CN",
     "冰箱收纳盒 透明 可叠放 食品级 省空间 蔬果分装",
     ["CN", "US"], [("S1", "透明四件", 79.0, "CNY", 150)], [("结构", "可堆叠透明盒")]),
    ("P1066", "BrewMate 双层玻璃杯", "BrewMate", "家居生活", "CN",
     "双层玻璃杯 隔热 耐热 咖啡 茶饮 办公 居家",
     ["CN", "JP", "SG"], [("S1", "360ml", 59.0, "CNY", 180)], [("手感", "双层防烫")]),
    ...
    # ---- 户外运动补充：提升“露营/徒步/应急”覆盖 ----
    ("P1067", "TrailMate 便携折叠桌", "TrailMate", "户外运动", "CN",
     "折叠桌 铝合金 轻便 露营 徒步 野餐 承重稳定",
     ["CN", "US", "EU"], [("S1", "原色", 159.0, "CNY", 75)], [("结构", "X 型折叠支架")]),
    ("P1068", "StormLite 头灯 充电款", "StormLite", "户外运动", "CN",
     "头灯 充电式 远射 防水 徒步 夜跑 应急 照明",
     ["CN", "US"], [("S1", "黑色", 109.0, "CNY", 140)], [("照明", "三档切换")]),
    ("P1069", "CampDry 防潮地垫", "CampDry", "户外运动", "CN",
     "防潮地垫 露营 隔湿 折叠 轻便 野餐 帐篷底垫",
     ["CN", "US", "EU"], [("S1", "橄榄绿", 89.0, "CNY", 160)], [("用途", "帐篷底部防潮")]),
]
